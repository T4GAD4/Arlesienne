...
class Marche extends CI_Controller {
	...
	public function index()
	{
            ...
            $this->load->view('pages/etats/marche');
	...
	public function generer()
	{
            ...
            $data['marches'] = $this->marches->getFromProjetAndCategorie($this->input->post('projet'),$this->input->post('categorie'));
            ...
            $this->load->view('template/header');
            $this->load->view('template/sidebar',$data);
            $this->load->view('pages/etats/generation/marche');
            $this->load->view('template/footer');
	}
}
