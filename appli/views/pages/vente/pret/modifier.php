<div class="container">
    ...
    <div class="row">
        <?php echo form_open_multipart(base_url('vente/modif_pret/' . $pret->id)); ?>

        <fieldset>
            <legend>Modifier le financement</legend>
            <!-- Date input-->
            <div class="form-group paddingTop">
                ...
                <div class='col-md-6 input-group date' id='datetimepicker'>
                    <input type='text' name="date_compromis" value="<?= set_value('date_compromis',$pret->date_signature); ?>" class="input-md form-control" />
            ...
            <div class="control-group">
                ...
                <div class="controls col-xs-12 col-sm-8 col-md-5 col-centered" style='text-align:center;'>
                    <input class="form-control" type="text" value="<?= set_value('delai',$pret->delai); ?>" name="delai"/>
            ...
            <div class="control-group col-md-offset-3 center">
                <div class="col-md-7">
                    <p style="color:white;">Soit date butoir le : <span id="date_butoir"><?= conv_date(date('Y-m-d', strtotime($pret->date_signature.' +'.(int)$pret->delai.' days'))); ?></span></p>
                </div>
            </div>
            <br/>
            <br/>
            ...
            <div class="form-group paddingTop">
                ...
                <div class='col-md-6 input-group date' id='datetimepicker1'>
                    <input type='text' name="date_obtention" value="<?= set_value('date_obtention',$pret->date_obtention_pret); ?>" class="input-md form-control" />
                    <span class="input-group-addon">
                        <span class="glyphicon glyphicon-calendar">
                        </span>
                    </span>
                ...
                <div class="controls col-xs-12 col-sm-8 col-md-5 col-centered">
                    <select name='banque' id="banque" class='chosen-select'>
                        ...
                        <?php foreach ($entreprises as $entreprise) { ?>
                            <option value="<?= $entreprise->id; ?>" <?php if(in_array($entreprise->id,(array)$pret->idBanque)){echo 'selected';} ?>><?= strtoupper($entreprise->nom); ?></option>
                        <?php } ?>
