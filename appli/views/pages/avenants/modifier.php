    ...
    <fieldset>
        ...
        <div class="form-facture row-centered" style="margin:0;">
            ...
            <div class="control-group">
                ...
                <div class="controls col-xs-12 col-sm-8 col-md-6 col-centered">
                    <input id="budget" name="date" placeholder="DD-MM-YYYY" type="text" value="<?php echo $avenant->date ?>" class="form-control">
            ...
            <div class="control-group">
                ...
                <div class="controls col-xs-12 col-sm-8 col-md-6 col-centered">
                    <input id="budget" name="montantHT" type="number" value="<?php echo $avenant->montantHT ?>" class="form-control">
