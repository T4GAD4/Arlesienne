...
<?php foreach ($categories as $categorie) { ?>
                    <div role="tabpanel" class="tab-pane active" id="<?= $categorie->categorie; ?>">
                        <div class="row">
                            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="false">
    <?php foreach ($categorie->bugs as $bug) {
        $i = 0; ?>
        ...
        <?php } ?>
                                                <div class="row">
                                                    <div class="col-md-12"><h6>URL du bug : <?= $bug->url_precedente; ?></h6></div>
                                                </div>
