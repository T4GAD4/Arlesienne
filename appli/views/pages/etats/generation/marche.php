<div class="container white">
    ...
    <div class="row white">
        <h2 class="hr white center">Synthése <?= $categorie; ?></h2>
    </div>
</div>
<div class="row">
    <div class="col-md-12 export">
        <div class="col-md-12" id="filtres" style="padding:20px;margin:20px;">
            FILTRES :<br/>
        ...
        <h3 class="hrblack black"><?= $projet->nom; ?> (Synthése <?= $categorie; ?>)</h3>
        ...
        <table class="table-striped table-hover table">
            ...
            foreach($marches as $marche){
                $entreprises = Array();
                foreach($marche->entreprises as $entreprise){
                    array_push($entreprises,$entreprise->nom);
                }
                ...
                $projetMarcheHT += $marche->montantHT + $marche->totalAvenantsHT;
                ...
                $projetARegler = $projetFacturesTTC - $projetReglements;
                $projetSolde = $projetMarcheTTC - $projetReglements;
            ?>
                <tr>
